...
//    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);
    ...
    public static final DeferredItem<Item> INCOMPLETE_ANCIENT_POKE_BALL = ITEMS.register(
            "incomplete_ancient_poke_ball",
            () -> new Item(new Item.Properties()) {
                @Override
                public boolean isEnabled(FeatureFlagSet enabledFeatures) {
                    return false;
    ...
    public static final DeferredItem<Item> INCOMPLETE_ANCIENT_GREAT_BALL = ITEMS.register(
            "incomplete_ancient_great_ball",
            () -> new Item(new Item.Properties()) {
                @Override
                public boolean isEnabled(FeatureFlagSet enabledFeatures) {
                    return false;
    ...
    public static final DeferredItem<Item> INCOMPLETE_ANCIENT_ULTRA_BALL = ITEMS.register(
            "incomplete_ancient_ultra_ball",
            () -> new Item(new Item.Properties()) {
                @Override
                public boolean isEnabled(FeatureFlagSet enabledFeatures) {
                    return false;
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB =
            CREATIVE_MODE_TABS.register("pixelcreate", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(INCOMPLETE_ANCIENT_POKE_BALL.get());
                        output.accept(INCOMPLETE_ANCIENT_GREAT_BALL.get());
                        output.accept(INCOMPLETE_ANCIENT_ULTRA_BALL.get());
                    }).build());
