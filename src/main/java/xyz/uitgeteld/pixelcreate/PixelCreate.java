...
public class PixelCreate {
    ...
    // Creates a new food item with the id "pixelcreate:example_id", nutrition 1 and saturation 2
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.pixelcreate")) //The language key for the title of your CreativeModeTab
